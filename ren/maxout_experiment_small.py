...
for network_rank in [3 for i in range(1)]:
    ###
    # Experiment hyperparameters
    ###
    experiment_number = random.randint(0,999999999999)
    experiment_info = "modelA = nothing; modelB = None; modelC = None; modelD = None; producing datapoints for testing correlation between cost vector and rate of convergence."
    num_runs = 1
    num_epochs = 2
    batch_size = 100
    learning_rate = 0.001
    ...
    for run in range(num_runs):
        ...
        modelC = None  # redistricting + rescaling
